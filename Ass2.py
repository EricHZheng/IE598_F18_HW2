...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep  9 00:58:32 2018
...
graph.write_png('tree.png')             #see file tree.png
...
print()
print('Combining weak to strong learners via random forests')
...
print()
print('K-nearest neighbors - a lazy learning algorithm')
...
for k in k_range:
    ...
    print('K: %d, Accuracy: %.6f' % (k,  accuracy_score(y_test, y_pred)))

import numpy    
print()
A = np.array(scores)
maxindex = np.where(A==max(scores))
ar = numpy.array(maxindex)
ar = ar+1
print('K = ', *ar, ',', 'Max Accuracy = %.6f' % max(scores))
